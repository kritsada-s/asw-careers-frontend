...
function HomeSearchHeader() {
    ...
    return (
        <section id="homeSearchHeader" className="min-h-[370px] relative flex justify-center items-center before:absolute before:bg-primary before:w-full before:h-full before:opacity-70">
