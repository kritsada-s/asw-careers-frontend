    ...
    return (
        <section id="welfareBenefit" className="flex lg:min-h-[600px] lg:pb-16">
            <div className="content-wrapper w-full lg:max-w-[1440px] 2xl:mx-auto flex flex-col lg:flex-row justify-end">
                ...
                <div className="welfare-benefit-box w-full lg:w-1/2 py-7 px-4 bg-primary-700 h-full rounded-tl-3xl lg:rounded-tl-none -mt-4 lg:mt-0 lg:rounded-bl-3xl flex flex-col justify-center items-center">
                    ...
                    <div className="core-benefit-boxes grid lg:grid-cols-2 lg:grid-rows-2 gap-y-6 lg:gap-y-7 lg:gap-x-10">
