    ...
    return (
        <section id="welfareBenefit" className="flex lg:min-h-[600px] lg:pb-16">
            <div className="content-wrapper w-full lg:max-w-[1440px] 2xl:mx-auto flex flex-col lg:flex-row justify-end">
                <Image src="/images/welfare_benefit-bg_1-5x.webp" alt="" width={480} height={280} className="lg:hiden w-auto h-auto"/>
                <div className="welfare-benefit-box w-full lg:w-1/2 py-7 px-4 bg-primary h-full rounded-tl-3xl -mt-4 lg:rounded-bl-3xl flex flex-col justify-center items-center">
                    ...
                    { benefits.map((item, key)=>(
                        <div className="benefit-box flex items-start gap-4">
