...
const SearchBox: React.FC<SearchBoxProps> = ({ onSearch }) => {
  ...
  return (
    <div className="flex justify-between p-[8px] bg-white rounded-[15px] w-full md:w-[750px]">
      <input type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)}  placeholder="ค้นหาตำแหน่งงาน" className="pl-2 md:pl-4 pr-1 py-0 border-none focus:outline-none focus:ring-0 w-full"/>
